...
class batchMatPolyZonotope:
    ...
    def __matmul__(self,other):
        ...
        if isinstance(other, torch.Tensor):
            ...
            if len(other.shape) == 1:
                Z = self.Z @ other
                return zp.batchPolyZonotope(Z,self.n_dep_gens,self.expMat,self.id,copy_Z=False).compress(1)
        ...
        elif isinstance(other, (zp.batchPolyZonotope, zp.polyZonotope)):
    ...
    def __rmatmul__(self,other):
        ...
        elif isinstance(other,zp.matPolyZonotope):
